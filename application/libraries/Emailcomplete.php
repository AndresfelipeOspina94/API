...
class Emailcomplete {
  ...
  public function send_mail_full($datos = NULL, $html) {
      $mail = new PHPMailer();
      ...
      $mail->Subject    = "Formlario completado";  //Asunto del mensaje
      $mail->Body      = $html;
      $mail->AltBody    = "Cuerpo en texto plano";

      //$destino = $datos->cliente['emailprincipal'];
      
      //PARA LOS ADMINITRADORES DE BTraining
      $destino = 'rm@programarte.com.co';
