                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td class="h1" style="padding: 5px 0 0 0;">
                      Formulario Terminado <?php echo $formulario['titulo'];?>
                    </td>
                  </tr>
                </table>
              </td>
      ...
      <tr>
        <td class="innerpadding borderbottom">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td class="h2">
                El cliente <?php echo $formulario['nombres']." ".$formulario['apellidos']; ?>!
              </td>
            </tr>
            <tr>
              <td class="bodycopy">
                El cliente finalizo con exito el formulario DRAS, Test de análisis psicológicos.
              </td>
            </tr>
          </table>
        </td>
            ...
            <tr>
              <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td class="bodycopy">
                      Este enlace estará vivo por unos días, le permitirá elaborar el test durante este tiempo. Luego será removido, si esto sucede, comuníquese con Btraining.
                    </td>
                  </tr>
                  <tr>
